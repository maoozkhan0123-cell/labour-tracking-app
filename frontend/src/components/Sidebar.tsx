...
export const Sidebar: React.FC<{ isCollapsed: boolean, setIsCollapsed: (c: boolean) => void }> = ({ isCollapsed, setIsCollapsed }) => {
    ...
    return (
        <nav className={`sidebar ${isCollapsed ? 'collapsed' : ''}`}>
            ...
            <ul className="nav-menu">
                ...
                <li>
                    <NavLink to="/control-matrix" className={({ isActive }) => `nav-item ${isActive ? 'active' : ''}`}>
                        <i className="fa-solid fa-table-cells"></i> <span>Control Matrix</span>
                    </NavLink>
                </li>
                <li>
                    <NavLink to="/control-table" className={({ isActive }) => `nav-item ${isActive ? 'active' : ''}`}>
                        <i className="fa-solid fa-table-list"></i> <span>Control Table</span>
                    </NavLink>
                </li>
                <li>
                    <NavLink to="/manufacturing-orders" className={({ isActive }) => `nav-item ${isActive ? 'active' : ''}`}>
                        <i className="fa-regular fa-clipboard"></i> <span>Manufacturing Orders</span>
                    </NavLink>
                </li>
                <li>
                    <NavLink to="/employee-activity" className={({ isActive }) => `nav-item ${isActive ? 'active' : ''}`}>
